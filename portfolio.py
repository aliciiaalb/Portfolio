...
But behind each number lies a story. Every language learning decision reflects an aspiration, a culture, or even an economic opportunity. This project allows you to visualize and better understand these dynamics, offering a fresh perspective on the French educational landscape.""")
    ...
    image_map_lyceens = {
        5: {'path': r"C:\Scolarité\Efrei\M1\DATAVIZ\Portfolio\screens\data_info.png", 'width': 500},
        7: {'path': r"C:\Scolarité\Efrei\M1\DATAVIZ\Portfolio\screens\columns.png", 'width': 600},
        11: {'path': r"C:\Scolarité\Efrei\M1\DATAVIZ\Portfolio\screens\Proportion of Girls and Boys in the Dataset.png", 'width': 600},
        15: {'path': r"C:\Scolarité\Efrei\M1\DATAVIZ\Portfolio\screens\Radar Chart of Gender Proportion by Educational Level.png", 'width': 600},  
        18: {'path': r"C:\Scolarité\Efrei\M1\DATAVIZ\Portfolio\screens\Proportion of Girls and Boys by Educational Level.png", 'width': 1200},
        20: {'path': r"C:\Scolarité\Efrei\M1\DATAVIZ\Portfolio\screens\Proportion of Girls and Boys by Educational Level2.png", 'width': 1200},
        22: {'path': r"C:\Scolarité\Efrei\M1\DATAVIZ\Portfolio\screens\Proportion of Girls and Boys by Educational Level3.png", 'width': 1200},
        27: {'path': r"C:\Scolarité\Efrei\M1\DATAVIZ\Portfolio\screens\Student population by sector.png", 'width': 650},
        31: {'path': r"C:\Scolarité\Efrei\M1\DATAVIZ\Portfolio\screens\Gender Proportions by Sector.png", 'width': 1000},
        39: {'path': r"C:\Scolarité\Efrei\M1\DATAVIZ\Portfolio\screens\Total Number of Students in Urban vs. Rural Areas.png", 'width': 900},
        44: {'path': r"C:\Scolarité\Efrei\M1\DATAVIZ\Portfolio\screens\Proportion of Students in Public vs. Private Sector (Urban vs. Rural).png", 'width': 900},
        50: {'path': r"C:\Scolarité\Efrei\M1\DATAVIZ\Portfolio\screens\Aggregated Distribution of LV1 Language Students by Region.png", 'width': 1400},
        53: {'path': r"C:\Scolarité\Efrei\M1\DATAVIZ\Portfolio\screens\Aggregated Distribution of LV1 (Spanish, German, and Other Languages) Students by Region.png", 'width': 1400},
        58: {'path': r"C:\Scolarité\Efrei\M1\DATAVIZ\Portfolio\screens\Aggregated Distribution of LV2 Language Students by Region.png", 'width': 1400},
        61: {'path': r"C:\Scolarité\Efrei\M1\DATAVIZ\Portfolio\screens\Aggregated Distribution of LV2 (English, German, Italian and Other Languages) Students by Region.png", 'width': 1400},
        65: {'path': r"C:\Scolarité\Efrei\M1\DATAVIZ\Portfolio\screens\map Total Other LV1 Languages.png", 'width': 1700},
        68: {'path': r"C:\Scolarité\Efrei\M1\DATAVIZ\Portfolio\screens\map Total Other LV2 Languages.png", 'width': 1700},
        72: {'path': r"C:\Scolarité\Efrei\M1\DATAVIZ\Portfolio\screens\Evolution of LV1 Language Enrollment by Educational Level.png", 'width': 1000},
        74: {'path': r"C:\Scolarité\Efrei\M1\DATAVIZ\Portfolio\screens\Evolution of LV1 Language Enrollment by Educational Level2.png", 'width': 1000},
        77: {'path': r"C:\Scolarité\Efrei\M1\DATAVIZ\Portfolio\screens\Evolution of LV2 Language Enrollment by Educational Level.png", 'width': 1000},
        79: {'path': r"C:\Scolarité\Efrei\M1\DATAVIZ\Portfolio\screens\Evolution of LV2 Language Enrollment by Educational Level2.png", 'width': 1000},
        82: {'path': r"C:\Scolarité\Efrei\M1\DATAVIZ\Portfolio\screens\Evolution of LV1 Language Choices Over the Years.png", 'width': 1400},
        83: {'path': r"C:\Scolarité\Efrei\M1\DATAVIZ\Portfolio\screens\Evolution of LV1 Language Choices Over the Years (Log Scale).png", 'width': 1400},
        85: {'path': r"C:\Scolarité\Efrei\M1\DATAVIZ\Portfolio\screens\Evolution of LV1 Language Choices Over the Years2.png", 'width': 1400},
        88: {'path': r"C:\Scolarité\Efrei\M1\DATAVIZ\Portfolio\screens\Evolution of LV2 Language Choices Over the Years.png", 'width': 1400},
        89: {'path': r"C:\Scolarité\Efrei\M1\DATAVIZ\Portfolio\screens\Evolution of LV2 Language Choices Over the Years (Log Scale).png", 'width': 1400},
        91: {'path': r"C:\Scolarité\Efrei\M1\DATAVIZ\Portfolio\screens\Evolution of LV2 Language Choices Over the Years2.png", 'width': 1400},
        94: {'path': r"C:\Scolarité\Efrei\M1\DATAVIZ\Portfolio\screens\Language Combinations (LV1 to LV2).png", 'width': 1300}
    }
    afficher_notebook_avec_images(r"C:\Scolarité\Efrei\M1\DATAVIZ\Portfolio\Project dataviz.ipynb", image_map_lyceens)
...
# "Projet 1 : Classification du diabète"
    ...
    afficher_notebook_avec_images(r"C:/Scolarité/Efrei/M1/ML/Notebook_Projet_ML_Alicia_LE_BRUN_I2_DE.ipynb", image_map_diabetes)
